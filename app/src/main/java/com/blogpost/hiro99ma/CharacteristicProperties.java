...
public class CharacteristicProperties {
    ...
    private boolean supports_indication=false;
    ...
    public boolean isSupports_indication() {
        return supports_indication;
    }

    public void setSupports_indication(boolean supports_indication) {
        this.supports_indication = supports_indication;
    }
